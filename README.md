HelloWorld. C Tutorials. Visual Studio IDE. Simple Input/Output.  Windows API. DialogBased GUI Application. 
...
HelloWorld. Занятия по C. ИС Microsoft Visual Studio. Windows API. Простой Ввод-Вывод. 
